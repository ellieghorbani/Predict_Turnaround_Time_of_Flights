...
<p align='justify'> 
In table 1, we show the percentage number of flights for different airlines. In this study we only focuse on airlines with more than 10 percent of total flights. Based on table 1, Airlines WN, AA, and OO with %22, %12, and %10 number flights, respectively, have the most stock of flights. The datafram is divided into 1217135, 673631, and 554286 tables for WN, AA, and OO airlines respectively.  <br />
</p>
<table> 
...
<b>Figure 6</b> Illustrate the scheduled departure time from airports B to C of OO, AA and WN airlines (from left to right). Blue points and light blue lines show average and interval of Turnaround time via time of day respectively.  Red points is number flights during the day. <br/> 
</p>
...
### 4.2. Modeling data to predict turnaround time based on knowing its distribution
<p align='justify'> 
...
### 4.3. Apply the best models to test data (unseen data)
<p align='justify'> 
...
In the next step, the gradient boosting model as the best model, is applied to predict turnaround time for those three airlines. For this fitting the most important features are arrival hour from airport A to B, scheduled departure hour from A to B and arrival delay from A to B for distribution1, and scheduled departure hour, delay in arrival from A to B and departure hour from A to B for distribution2.<br/>
<p/>
