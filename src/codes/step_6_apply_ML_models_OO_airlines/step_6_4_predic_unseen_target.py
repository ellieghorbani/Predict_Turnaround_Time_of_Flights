...
def logistic_model(features_data, target_data, rand_state):
    ...
    plt.savefig("the_most_important_OO_LogisticRegression.png", bbox_inches='tight')
    return model
...
## Read Data!
data_seen = pd.read_csv("data_seen_OO_airlines.csv")
#print('shape of data_seen:', data_seen.shape)
data_unseen = pd.read_csv("data_unseen_OO_airlines.csv")
...
logistic_model = logistic_model(features_seen, target_seen_bio, 1040)
...
## Unseen Data
target_unseen_predict_logistic = logistic_model.predict(features_unseen)
target_unseen_copy = target_unseen.copy()
target_unseen_copy[target_unseen <= 4] = 1
target_unseen_copy[target_unseen > 4] = 2
### plot category of distrbutions based on logistic_model 
cm = confusion_matrix(target_unseen_copy, target_unseen_predict_logistic)
...
# seprate unseen data two distributions without logistic model
...
#----------------------------------------------------------------
#predict distribution of data by useing logistic model
index1 = target_unseen[target_unseen_predict_logistic == 1].index
index2 = target_unseen[target_unseen_predict_logistic == 2].index
features_unseen_predict_logistic_1 = features_unseen.loc[index1]
features_unseen_predict_logistic_2 = features_unseen.loc[index2]
target_unseen_predict_logistic_1 = target_unseen[index1]
target_unseen_predict_logistic_2 = target_unseen[index2]
#print('mean(target_unseen_predict_logistic_1)', np.mean(target_unseen_predict_logistic_1), 'mean(target_unseen_predict_logistic_2)', np.mean(target_unseen_predict_logistic_2))
...
table_1_p = check_models_with_unseen_data(model_1, "unseen_forest_predicted_1", target_unseen_predict_logistic_1, features_unseen_predict_logistic_1)
table_2 = check_models_with_unseen_data(model_2, "unseen_2", target_unseen_2, features_unseen_2)
table_2_p = check_models_with_unseen_data(model_2, "unseen_forest_predicted_2", target_unseen_predict_logistic_2, features_unseen_predict_logistic_2)
...
print("mean_target_unseen_predict_OO:", mean_target_unseen_predict)
print("mean_target_unseen_OO",mean_target_unseen)

#RMSE real data
RMSE_targer = np.sqrt(sum((target_unseen - mean_target_unseen)**2))/len(target_unseen)
print("RMSE_targer_OO:", RMSE_targer)
...
print("RMSE_targer_predict_OO:", RMSE_targer_predict)
