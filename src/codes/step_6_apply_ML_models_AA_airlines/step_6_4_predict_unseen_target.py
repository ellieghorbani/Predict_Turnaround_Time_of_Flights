...
print("mean_target_unseen_predict_AA:", mean_target_unseen_predict)
print("mean_target_unseen_AA",mean_target_unseen)



#RMSE real data
RMSE_targer = np.sqrt(sum((target_unseen - mean_target_unseen)**2))/len(target_unseen)
print("RMSE_targer_AA:", RMSE_targer)
...
print("RMSE_targer_predict_AA:", RMSE_targer_predict)
